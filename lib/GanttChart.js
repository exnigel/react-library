...
function GanttChart(props) {
    ...
    const [hoverIndex, setHoverIndex] = (0, react_1.useState)(null);
    ...
    const renderLabel = (row, index) => {
        ...
        return (react_1.default.createElement("div", { key: index, className: "gantt-label", style: Object.assign(Object.assign({}, labelStyle), { paddingLeft: row.level * 10, position: "relative", paddingRight: 25 }) },
            react_1.default.createElement("span", { style: { fontSize: 12 }, onClick: () => {
                    if (props.onRowClick) {
                        props.onRowClick(index);
                    }
                } }, row.label),
            showMenu ? (react_1.default.createElement("div", { className: "menu", style: { position: "absolute", right: 5, top: 1 } },
                react_1.default.createElement("div", { style: { cursor: "pointer", visibility: hoverIndex == index ? "visible" : "hidden" }, "data-bs-toggle": "dropdown" },
                ...
                react_1.default.createElement("ul", { className: "dropdown-menu", style: { marginTop: 0 } },
                    props.onInsertRowAbove != null ? (react_1.default.createElement("li", null,
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onInsertRowAbove(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-chevron-up" }),
                            " ",
                            props.T("Add Above")))) : null,
                    props.onInsertRowBelow != null ? (react_1.default.createElement("li", null,
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onInsertRowBelow(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-chevron-down" }),
                            " ",
                            props.T("Add Below")))) : null,
                    props.onInsertChildRow != null ? (react_1.default.createElement("li", null,
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onInsertChildRow(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-chevron-right" }),
                            " ",
                            props.T("Add Subitem")))) : null,
                    canMoveUp ? (react_1.default.createElement("li", { key: "moveUp" },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onMoveRowUp(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-arrow-up" }),
                            " ",
                            props.T("Move Up")))) : null,
                    canMoveDown ? (react_1.default.createElement("li", { key: "moveDown" },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onMoveRowDown(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-arrow-down" }),
                            " ",
                            props.T("Move Down")))) : null,
                    canMoveLeft ? (react_1.default.createElement("li", { key: "moveLeft" },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onMoveRowLeft(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-arrow-left" }),
                            " ",
                            props.T("Move Left")))) : null,
                    canMoveRight ? (react_1.default.createElement("li", { key: "moveRight" },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onMoveRowRight(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-arrow-right" }),
                            " ",
                            props.T("Move Right")))) : null,
                    props.onRemoveRow ? (react_1.default.createElement("li", { key: "removeRow" },
                        react_1.default.createElement("a", { className: "dropdown-item", onClick: () => props.onRemoveRow(index) },
                            react_1.default.createElement("i", { className: "fa fa-fw text-secondary fa-remove" }),
                            " ",
                            props.T("Remove")))) : null))) : null));
    };
    return (react_1.default.createElement("div", { style: { position: "relative" }, onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave, onClick: handleClick, ref: containerRef },
        ...
        react_1.default.createElement("div", { key: "hover-row" }, hoverIndex != null ? (react_1.default.createElement("div", { style: {
                left: 0,
                right: 0,
        ...
        react_1.default.createElement("div", { key: "main", style: { display: "grid", gridTemplateColumns: "auto 1fr" } },
            react_1.default.createElement("div", { key: "left", style: { paddingLeft: 5, paddingTop: headerHeight, marginBottom: scrollBarHeight } },
                ...
                props.onAddRow ? (react_1.default.createElement("div", { key: "add", className: "no-print" },
                    react_1.default.createElement("a", { style: { fontSize: 12, cursor: "pointer" }, onClick: props.onAddRow }, props.addRowLabel ? props.addRowLabel : react_1.default.createElement("i", { className: "fa fa-plus" })))) : null),
...
function GanttBarArea(props) {
    ...
    const scrollLeftBy = (0, react_1.useRef)(0);
    // Expand to nearest month
    const startDate = (0, moment_1.default)(props.startDate, "YYYY-MM-DD").startOf("month");
    const endDate = (0, moment_1.default)(props.endDate, "YYYY-MM-DD").endOf("month");
    ...
    const dateToPx = (0, react_1.useCallback)((date) => {
    ...
    const renderBar = (row, index) => {
        ...
        if (row.startDate && row.endDate && row.startDate != row.endDate) {
            const rowStartDate = (0, moment_1.default)(row.startDate, "YYYY-MM-DD");
            const rowEndDate = (0, moment_1.default)(row.endDate, "YYYY-MM-DD");
        ...
        // Diamonds for single dates
            ...
            const rowDate = (0, moment_1.default)(row.startDate || row.endDate, "YYYY-MM-DD");
    ...
    const todayPx = dateToPx((0, moment_1.default)());
...
function YearScale(props) {
    ...
    const date = (0, moment_1.default)(startDate);
    /** Start and end of each segment to draw */
    const segs = [];
    while (date.isBefore(endDate)) {
        const itemStart = (0, moment_1.default)(date);
        date.add(1, "years");
        const itemEnd = (0, moment_1.default)(date);
    ...
    return (react_1.default.createElement("g", null, segs.map((seg, i) => {
        ...
        return (react_1.default.createElement("g", { key: i },
            ...
            react_1.default.createElement("text", { textAnchor: "middle", x: (left + right) / 2, y: 8, fill: "#333", fontSize: 9 }, seg[0].format("YYYY"))));
    })));
}
...
function MonthScale(props) {
    ...
    return (react_1.default.createElement("g", null, segs.map((seg, i) => {
        ...
        return (react_1.default.createElement("g", { key: i },
            ...
            react_1.default.createElement("text", { key: "text", textAnchor: "middle", x: (left + right) / 2, y: 21, fill: "#666", fontSize: 9 }, seg[0].format("MMM"))));
    })));
}
/** Display scale at top for each week or day (if scale permits) */
function DayWeekScale(props) {
    const { startDate, endDate } = props;
    const date = (0, moment_1.default)(startDate).startOf("week");
    /** Start and end of each segment to draw */
    const segs = [];
    ...
    return (react_1.default.createElement("g", null, segs.map((seg, i) => {
        ...
        return (react_1.default.createElement("g", { key: i },
            ...
            react_1.default.createElement("text", { key: "text", textAnchor: "middle", x: (left + right) / 2, y: 31, fill: "#AAA", fontSize: 9 }, seg[0].format("DD"))));
    })));
}
