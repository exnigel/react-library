...
function ListEditorComponent(props) {
    ...
    const renderListItem = (item, index) => {
        ...
        return (react_2.default.createElement("li", { className: isActive ? "px-4 py-2 border-b border-border last:border-b-0 bg-primary text-on-primary" : "px-4 py-2 border-b border-border last:border-b-0 bg-surface text-ink", onClick: props.editLink ? undefined : handleClick, key: index },
    ...
    return (react_2.default.createElement("div", null,
        ...
        props.getReorderableKey ? (react_2.default.createElement(ReorderableListComponent_1.default, { items: props.items, getItemId: props.getReorderableKey, onReorder: props.onItemsChange, renderItem: renderDraggableListItem, element: react_2.default.createElement("ul", { className: "flex flex-col rounded-md overflow-hidden border border-border-strong" }) })) : (react_2.default.createElement("ul", { className: "flex flex-col rounded-md overflow-hidden border border-border-strong" }, props.items.map(renderListItem))),
