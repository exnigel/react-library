...
class InnerModalComponent extends react_1.default.Component {
    render() {
        ...
        return R("div", { style: rootStyle, className: "fixed inset-0 z-[1055] overflow-y-auto outline-none" }, R("style", null, "body { overflow-y: hidden }"), R("div", { style: overlayStyle, onClick: this.props.onClose }), R("div", { className: `relative mx-auto my-8 w-[calc(100%-1rem)] ${dialogSizeClass}`, style: dialogStyle }, R("div", { className: "relative flex flex-col w-full bg-white border border-black/20 rounded-md shadow-lg outline-none" }, this.props.header
            ? R("div", { className: "flex items-center justify-between px-4 py-3 border-b border-gray-200 rounded-t-md" }, R("h5", { className: "text-lg font-medium m-0", "data-testid": "modal-title" }, this.props.header), this.props.showCloseX
