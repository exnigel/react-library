...
class InnerModalComponent extends react_1.default.Component {
    render() {
        ...
        { className: "relative flex flex-col w-full bg-surface text-ink border border-border-strong rounded-md outline-none" }, this.props.header
            ? R("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border rounded-t-md" }, R("h5", { className: "text-lg font-medium m-0", "data-testid": "modal-title" }, this.props.header), this.props.showCloseX
