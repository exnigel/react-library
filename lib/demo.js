...
const ListEditorComponent_1 = require("./ListEditorComponent");
class PopoverHelpSample extends react_1.default.Component {
    render() {
        return R("div", { style: { margin: 20 } }, R(PopoverHelpComponent_1.default, null, "This is a test"));
    }
}
...
class BlocksComponent extends react_1.default.Component {
    ...
    renderItem(item, index, connectDragSource, connectDragPreview, connectDropTarget) {
        ...
        }, R("span", { className: "fas fa-arrows-alt" }))), e);
        switch (item.type) {
            case "title":
...
class AutoSizeTestComponent extends react_1.default.Component {
    render() {
        ...
        return R(AutoSizeComponent_1.default, {
            injectHeight: true,
            children: (size) => {
...
function ListEditorComponentSample(props) {
    const [items, setItems] = (0, react_1.useState)(["a", "b", "c"]);
    return react_1.default.createElement(ListEditorComponent_1.ListEditorComponent, { items: items, onItemsChange: setItems, renderItem: (item, index) => react_1.default.createElement("div", { key: item }, item), getReorderableKey: (item, index) => index });
}
const ReorderDemoWrapped = (0, react_dnd_1.DragDropContext)(react_dnd_html5_backend_1.default)(ReorderDemo);
const ListEditorComponentSampleWrapped = (0, react_dnd_1.DragDropContext)(react_dnd_html5_backend_1.default)(ListEditorComponentSample);
// ReactDOM.render(R(PopoverHelpSample), document.getElementById("main"))
react_dom_1.default.render(R(ListEditorComponentSampleWrapped), document.getElementById("main"));
