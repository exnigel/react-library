...
class InnerModalComponent extends React.Component<InnerModalComponentProps> {
  ...
  titleId = _.uniqueId("modal-title-")
  ...
  handleKeyDown = (e: KeyboardEvent) => {
    ...
    if (e.key === "Tab" && this.dialogRef.current) {
      const focusable = Array.from(this.dialogRef.current.querySelectorAll<HTMLElement>(FOCUSABLE_SELECTOR))
        ...
        R(
          ...
          this.props.header
            ? R(
                ...
                R("h5", { id: this.titleId, className: "text-lg font-medium m-0", "data-testid": "modal-title" }, this.props.header),
