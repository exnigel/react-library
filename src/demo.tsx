...
class ModalWindowSample extends React.Component<any, any> {
  ...
  render() {
    ...
    return R(
      "div",
      null,
      R("a", { onClick: this.startEditing }, "Edit me"),
      this.state.editing
        ? R(
            ModalWindowComponent,
            { isOpen: this.state.editing, onRequestClose: this.finishEditing },
            R(
              "div",
              null,
  ...
  render() {
    return R(
      ...
      this.state.editing
        ? R(
            ModalPopupComponent,
            { onClose: this.handleModalClose, showCloseX: true, width: 350 },
            R(
              "div",
              null,
              _.map(_.range(1, 100), (x) => R("div", null, `${x}`))
      ...
      this.props.connectDropTarget(
        R(
          ...
          R(
            ...
            R("span", null, this.props.item.id, this.state.value),
            R(
              "div",
              null,
              R(
...
class SortableSample extends React.Component<any, any> {
  ...
  render() {
    ...
    return R(
      "div",
      { style },
      R("button", { onClick: this.addNewItem }, "Add new item"),
      R(
        "table",
        null,
        R("thead", null, R("tr", null, R("th", null, "Item Name"))),
